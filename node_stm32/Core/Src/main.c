...
int main(void)
{
  ...
  LoRaTaskHandle = osThreadNew(StartDefaultTask, NULL, &LoRaTask_attributes);

  /* creation of IMUTask */
  IMUTaskHandle = osThreadNew(StartTIMUTask, NULL, &IMUTask_attributes);

  /* creation of SoilTask */
  SoilTaskHandle = osThreadNew(StartTask03, NULL, &SoilTask_attributes);

  /* creation of GNSSTask */
  GNSSTaskHandle = osThreadNew(StartTask04, NULL, &GNSSTask_attributes);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, SPI_CS_Pin|GPIO_PIN_11|GPIO_PIN_12, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI_CS_Pin PA11 PA12 */
  GPIO_InitStruct.Pin = SPI_CS_Pin|GPIO_PIN_11|GPIO_PIN_12;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
/* USER CODE BEGIN Header_StartTIMUTask */
/**
* @brief Function implementing the IMUTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartTIMUTask */
void StartTIMUTask(void *argument)
{
  /* USER CODE BEGIN StartTIMUTask */
  /* Infinite loop */
  for(;;)
  {
	  osThreadFlagsWait(0x01, osFlagsWaitAny, osWaitForever);
	  IMU_Trigger_DMA_Read();
...
void StartTask03(void *argument)
{
  ...
  for(;;)
  {
	...
	uint32_t flag = osThreadFlagsWait(0x01, osFlagsWaitAny, 20U);
